SEO means Search Engine Optimization. It's a process of increasing the quality and quantity of website traffic. One way to improve your SEO is to use meta descriptions. A meta description is a short summary of a web page that is displayed in search engine results pages. Here is an example of using the meta element to set a page description for a gardening site:
